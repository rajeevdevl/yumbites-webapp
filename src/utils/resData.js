export let resList = [
  {
    ...
    itemName: "hahahhahh",
    itemDescription:
      "Grilled kebabs made with marinated lamb, served with naan.",
    itemPrice: 450.0,
  ...
  },
  {
    ...
    itemName: "Baklava",
    itemDescription:
      "Sweet pastry made with layers of filo dough, honey, and nuts.",
    itemPrice: 200.0,
    restaurantName: "Peacock Rooftop Restaurant",
    restaurantID: 28,
  ...
  },
  {
    ...
    itemDescription:
      "A complete Bengali meal served with rice, dal, vegetables, and fish curry.",
    itemPrice: 500.0,
  ...
  },
  {
    ...
    restaurantID: 20,
    imageUrl:
      "https://fakerestaurantapi.runasp.net/images/chettinad%20chicken.jpg",
  },
  {
    itemID: 88,
    ...
    restaurantID: 4,
    imageUrl:
      "https://fakerestaurantapi.runasp.net/images/chickenn%20biryani.webp",
  },
  {
    itemID: 79,
  ...
  },
  {
    ...
    itemDescription:
      "Sweet dessert made with fried bread soaked in milk and flavored with saffron.",
    itemPrice: 180.0,
    restaurantName: "Shah Ghouse",
    restaurantID: 3,
    imageUrl: "https://fakerestaurantapi.runasp.net/images/",
  },
  {
    itemID: 54,
    itemName: "Filter Coffee",
    itemDescription:
      "Traditional South Indian coffee brewed with a drip filter.",
    itemPrice: 100.0,
    restaurantName: "Dakshin",
    restaurantID: 20,
  ...
  },
  {
    ...
    itemDescription:
      "Deep-fried fish marinated with spices, served with chutney.",
    itemPrice: 350.0,
  ...
  },
  {
    ...
    itemName: "Fish Curry",
    itemDescription:
      "Spicy fish curry cooked with traditional South Indian spices.",
    itemPrice: 350.0,
    restaurantName: "Koshy’s",
    restaurantID: 18,
  ...
  },
  {
    ...
    itemDescription:
      "Spicy Thai green curry made with coconut milk and vegetables.",
    itemPrice: 400.0,
  ...
  },
  {
    ...
    itemDescription:
      "Fresh salmon grilled to perfection, served with lemon butter sauce.",
    itemPrice: 700.0,
    restaurantName: "The Table",
    restaurantID: 14,
    imageUrl:
      "https://fakerestaurantapi.runasp.net/images/grilled%20salmon.jpg",
  },
  {
    itemID: 30,
  ...
  },
  {
    ...
    itemName: "Haleem",
    itemDescription:
      "Rich and creamy stew made with lentils, wheat, and slow-cooked meat.",
    itemPrice: 220.0,
  ...
  },
  {
    ...
    itemName: "Haleem",
    itemDescription:
      "A slow-cooked stew made with meat, lentils, and spices, a Hyderabadi specialty.",
    itemPrice: 250.0,
    restaurantName: "Shah Ghouse",
    restaurantID: 3,
    imageUrl: "https://fakerestaurantapi.runasp.net/images/haleem.jpg",
  },
  {
    ...
    itemDescription:
      "Fragrant rice with tender mutton, cooked with spices and herbs.",
    itemPrice: 420.0,
    restaurantName: "Mumtaz Restaurant",
    restaurantID: 6,
    imageUrl:
      "https://fakerestaurantapi.runasp.net/images/hyderabad%20biryani.jpg",
  },
  {
    itemID: 7,
    itemName: "Hyderabadi Biryani",
    itemDescription:
      "Fragrant basmati rice cooked with mutton and aromatic spices.",
    itemPrice: 350.0,
    restaurantName: "Shah Ghouse",
    restaurantID: 3,
    imageUrl:
  ...
  },
  {
    ...
    itemName: "Hyderabadi Biryani",
    itemDescription:
      "Fragrant basmati rice cooked with marinated meat and spices, served with raita.",
    itemPrice: 350.0,
  ...
  },
  {
    ...
    itemName: "Hyderabadi Biryani",
    itemDescription:
      "Traditional Hyderabadi biryani made with tender mutton and fragrant rice.",
    itemPrice: 400.0,
  ...
  },
  {
    ...
    itemName: "Hyderabadi Biryani",
    itemDescription:
      "Aromatic rice and tender mutton cooked with traditional spices.",
    itemPrice: 360.0,
    restaurantName: "Alhamdulillah Hotel",
    restaurantID: 9,
    imageUrl:
  ...
  },
  {
    ...
    itemDescription:
      "Steamed rice cakes served with spicy lentil soup and chutneys.",
    itemPrice: 150.0,
    restaurantName: "Dakshin",
    restaurantID: 20,
  ...
  },
  {
    ...
    itemDescription:
      "Traditional Mughlai biryani made with fragrant rice and marinated meat.",
    itemPrice: 350.0,
    restaurantName: "Karim’s",
    restaurantID: 13,
    imageUrl:
      "https://fakerestaurantapi.runasp.net/images/karim's%20biryani.jpg",
  },
  {
    itemID: 32,
    itemName: "Kebabs",
    itemDescription:
      "Grilled chicken and mutton skewers marinated with spices.",
    itemPrice: 280.0,
    restaurantName: "Karim’s",
    restaurantID: 13,
  ...
  },
  {
    ...
    itemName: "Kebabs",
    itemDescription:
      "Tender chicken and mutton marinated in spices and grilled to perfection.",
    itemPrice: 350.0,
  ...
  },
  {
    ...
    itemDescription:
      "A traditional Kerala feast with rice, sambar, and a variety of curries.",
    itemPrice: 600.0,
    restaurantName: "Rawat Mishtan Bhandar",
    restaurantID: 27,
  ...
  },
  {
    ...
    itemDescription:
      "Spicy curry made with tender meatballs cooked in a flavorful gravy.",
    itemPrice: 300.0,
    restaurantName: "Jewel of Nizam",
    restaurantID: 2,
  ...
  },
  {
    ...
    itemDescription:
      "Traditional Bengali fish curry made with mustard oil and spices.",
    itemPrice: 400.0,
  ...
  },
  {
    ...
    itemDescription:
      "Sticky rice topped with fresh mango slices and coconut milk.",
    itemPrice: 180.0,
    restaurantName: "Benjarong",
    restaurantID: 22,
    imageUrl:
      "https://fakerestaurantapi.runasp.net/images/mago%20sticky%20rice.jpg",
  },
  {
    itemID: 38,
  ...
  },
  {
    ...
    itemDescription:
      "Spicy and tangy curry made with green chilies and peanuts.",
    itemPrice: 200.0,
    restaurantName: "Paradise Biryani",
    restaurantID: 1,
    imageUrl:
      "https://fakerestaurantapi.runasp.net/images/mirch%20ka%20salan.jpg",
  },
  {
    itemID: 66,
    itemName: "Misti Doi",
  ...
  },
  {
    ...
    restaurantID: 15,
    imageUrl:
      "https://fakerestaurantapi.runasp.net/images/molecular%20biryani.png",
  },
  {
    itemID: 86,
    itemName: "Murg Malai Tikka",
    itemDescription:
      "Chicken marinated in cream and spices, grilled to perfection.",
    itemPrice: 350.0,
    restaurantName: "Gopi Dining Hall",
    restaurantID: 31,
    imageUrl:
      "https://fakerestaurantapi.runasp.net/images/murgh%20malai%20tikka.jpg",
  },
  {
    itemID: 89,
    itemName: "Mutton Biryani",
    itemDescription:
      "Traditional Hyderabadi biryani made with flavorful mutton.",
    itemPrice: 350.0,
    restaurantName: "Bawarchi",
    restaurantID: 4,
    imageUrl:
      "https://fakerestaurantapi.runasp.net/images/mutton%20biryani.jpg",
  },
  {
    itemID: 92,
    itemName: "Mutton Biryani",
  ...
  },
  {
    ...
    itemDescription:
      "Minced mutton cooked with spices and served with soft bread.",
    itemPrice: 280.0,
    restaurantName: "Koshy’s",
    restaurantID: 18,
  ...
  },
  {
    ...
    itemName: "Mutton Korma",
    itemDescription:
      "Tender mutton cooked in a rich, spiced gravy with yogurt and nuts.",
    itemPrice: 450.0,
    restaurantName: "Paradise Biryani",
    restaurantID: 1,
    imageUrl: "https://fakerestaurantapi.runasp.net/images/mutton-korma.jpg",
  },
  {
    ...
    itemDescription:
      "Mutton cooked in a rich, aromatic gravy with Bengali spices.",
    itemPrice: 450.0,
    restaurantName: "Peter Cat",
    restaurantID: 24,
    imageUrl:
      "https://fakerestaurantapi.runasp.net/images/mutton%20rezela.webp",
  },
  {
    itemID: 45,
    itemName: "Mysore Pak",
  ...
  },
  {
    ...
    itemName: "Payasam",
    itemDescription:
      "Traditional Kerala dessert made with rice and coconut milk.",
    itemPrice: 150.0,
    restaurantName: "Rawat Mishtan Bhandar",
    restaurantID: 27,
  ...
  },
  {
    ...
    itemDescription:
      "Moist cake made with pineapple and coconut, topped with cream.",
    itemPrice: 180.0,
    restaurantName: "Rajwadu",
    restaurantID: 30,
    imageUrl:
      "https://fakerestaurantapi.runasp.net/images/Pineapple-Coconut-cake.jpg",
  },
  {
    itemID: 51,
    itemName: "Pizza Margherita",
    itemDescription:
      "Classic pizza topped with mozzarella, tomatoes, and fresh basil.",
    itemPrice: 400.0,
    restaurantName: "Toit Brewery",
    restaurantID: 19,
    imageUrl:
      "https://fakerestaurantapi.runasp.net/images/pizza%20margaritta.webp",
  },
  {
    itemID: 55,
    itemName: "Plain Idli",
  ...
  },
  {
    ...
    restaurantID: 7,
    imageUrl:
      "https://fakerestaurantapi.runasp.net/images/Chingri-Malai-Curry.jpg",
  },
  {
    itemID: 18,
    itemName: "Qubani ka Meetha",
    itemDescription:
      "A traditional Hyderabadi dessert made with apricots and sugar.",
    itemPrice: 150.0,
    restaurantName: "Sarvi Restaurant",
    restaurantID: 8,
    imageUrl:
      "https://fakerestaurantapi.runasp.net/images/qubani%20ka%20meetha.jpg",
  },
  {
    itemID: 42,
    ...
    restaurantID: 16,
    imageUrl:
      "https://fakerestaurantapi.runasp.net/images/raspberry-sorbet.webp",
  },
  {
    itemID: 43,
    itemName: "Rava Idli",
    itemDescription:
      "Soft and fluffy semolina idli served with coconut chutney and sambar.",
    itemPrice: 150.0,
    restaurantName: "Mavalli Tiffin Room (MTR)",
    restaurantID: 17,
  ...
  },
  {
    ...
    itemName: "Sali Boti",
    itemDescription:
      "Parsi-style meat cooked with gravy and served with crisp fries.",
    itemPrice: 500.0,
    restaurantName: "Britannia & Co.",
    restaurantID: 16,
  ...
  },
  {
    ...
    itemName: "Sandesh",
    itemDescription:
      "Traditional Bengali sweet made with fresh paneer and flavored with cardamom.",
    itemPrice: 120.0,
    restaurantName: "6 Ballygunge Place",
    restaurantID: 25,
  ...
  },
  {
    ...
    itemName: "Shahi Tukda",
    itemDescription:
      "Deep-fried bread soaked in milk and sugar syrup, garnished with nuts.",
    itemPrice: 180.0,
    restaurantName: "Gopi Dining Hall",
    restaurantID: 31,
    imageUrl: "https://fakerestaurantapi.runasp.net/images/shahi-tukda.jpg",
  ...
  },
  {
    ...
    itemName: "Shawarma",
    itemDescription:
      "Chicken or lamb wrapped in pita bread with garlic sauce and vegetables.",
    itemPrice: 350.0,
    restaurantName: "Peacock Rooftop Restaurant",
    restaurantID: 28,
    imageUrl:
      "https://fakerestaurantapi.runasp.net/images/Chicken-Shawarma.jpg",
  },
  {
    itemID: 6,
    itemName: "Sheer Korma",
    itemDescription:
      "Sweet dessert made with milk, dry fruits, and vermicelli.",
    itemPrice: 150.0,
    restaurantName: "Jewel of Nizam",
    restaurantID: 2,
  ...
  },
  {
    ...
    itemName: "Tiramisu",
    itemDescription:
      "Classic Italian dessert made with layers of coffee-soaked cake and mascarpone.",
    itemPrice: 350.0,
    restaurantName: "The Table",
    restaurantID: 14,
  ...
  },
  {
    ...
    restaurantID: 22,
    imageUrl:
      "https://fakerestaurantapi.runasp.net/images/tom%20yum%20soup.jpg",
  },
  {
    itemID: 35,
    ...
    restaurantID: 14,
    imageUrl:
      "https://fakerestaurantapi.runasp.net/images/truffled-mac-cheese.webp",
  },
  {
    itemID: 56,
    itemName: "Vada",
  ...
  },
  {
    ...
    restaurantID: 10,
    imageUrl:
      "https://fakerestaurantapi.runasp.net/images/vegetable%20biryani.jpg",
  },
];
